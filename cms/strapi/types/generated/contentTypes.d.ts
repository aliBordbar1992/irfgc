...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['TOURNAMENT', 'CASUAL', 'ONLINE', 'OFFLINE']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    forumThreads: Schema.Attribute.Relation<
      'oneToMany',
    ...
    lfgPosts: Schema.Attribute.Relation<'oneToMany', 'api::lfg-post.lfg-post'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNewsPostNewsPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['ANNOUNCEMENT', 'TOURNAMENT', 'COMMUNITY', 'GAME_UPDATE', 'GENERAL']
    > &
